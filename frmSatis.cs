...
namespace Stok_Takibi
{
    public partial class frmSatis : Form
    {
        ...
        //buton ve marka için ayrı ayrı tanımlama yaptık
        ...
        {
            //formlar arası geçiş sağlamnak için
        ...
        private void txtTc_TextChanged(object sender, EventArgs e)
        {
            ...
            //kayıtlar okunduğu sürece işlem yapılsın
            while(read.Read())
            {
                    //veri tabanından çekmek için
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            {
                    baglanti.Open();
                    SqlCommand komut2 = new SqlCommand("update sepet set miktari=miktari+'"+int.Parse(txtMiktarı.Text)+ "'wherebarkodno='" + txtBarkodNo.Text + "'", baglanti);
                    komut2.ExecuteNonQuery(); 
                    SqlCommand komut3 = new SqlCommand("update sepet set toplamfiyat=miktari*satisfiyati wherebarkodno='"+txtBarkodNo.Text+"'", baglanti);
            ...
            sepetlistele();
            Hesapla();
            //işlemden sonra temizleme yapmak için
            foreach (Control item in groupBox2.Controls)
            {
                if (item is TextBox)
                {
        ...
        private void btnSatışİptal_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            baglanti.Close();
            MessageBox.Show("Ürünün satışı iptal edildi");
            daset.Tables["sepet"].Clear();
            sepetlistele();
            Hesapla();
        }
